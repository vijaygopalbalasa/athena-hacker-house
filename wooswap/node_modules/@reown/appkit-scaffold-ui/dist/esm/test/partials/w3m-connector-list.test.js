...
import { ApiController, ChainController, ConnectorController, CoreHelperUtil } from '@reown/appkit-controllers';
...
describe('W3mConnectorList', () => {
    ...
    it('should render only specified connector types in correct order', async () => {
        ...
        const element = await fixture(html `<w3m-connector-list .connectors=${testConnectors}></w3m-connector-list>`);
        element.explorerWallets = [{ id: 'MetaMask', name: 'MetaMask' }];
        await element.updateComplete;
        const flexChildren = element.shadowRoot?.querySelector('wui-flex')?.children;
